#!/usr/bin/env bash
# 轮流对话 Python 依赖（openai / webrtcvad / nltk+VADER）
#
...
pip3 install --no-cache-dir "openai==1.14.1" "webrtcvad==2.0.10" "httpx<0.28" "nltk>=3.6"
python3 - <<'PY'
import nltk
import openai
import webrtcvad
...
print("ok: openai", openai.__version__, "vader ready")
PY
